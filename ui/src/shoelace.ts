...
const ICONS: Record<string, string> = {
  ...
  // The app's own mark: an archive box, the thing ark is. Opens the About
  // dialog from the toolbar, and `ui/icon.png` draws the same box for Moss.
  archive:
  ...
  // The Filters toggle, in both states. Outline means "no filter is set";
  // filled means the results are narrowed and the funnel says so at a glance,
  // whether or not the panel is open. An invisible filter has already emptied
  // this app's results once.
  funnel:
