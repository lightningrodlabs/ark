...
**Files:**
- Create: `flake.nix`, `rust-toolchain.toml`, `Cargo.toml`, `package.json`, `.gitignore`
...
`dnas/ark/zomes/integrity/ark/src/lib.rs`:
...
`dnas/ark/zomes/integrity/ark/src/lib.rs` — replace the empty enums and `validate`:
